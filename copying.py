...
start_epoch_t=torch.zeros(1)
ctr_t=torch.zeros(1)
best_acc_t=torch.zeros(1)
start_epoch_t.load_state_dict(modelstate['epoch'])
ctr_t.load_state_dict(modelstate['ctr'])
best_acc_t.load_state_dict(model_state['best_acc'])
